...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default=r'G:\low-light_image_enhancement\dataset\MIT\GT', type=str)
    ...
    parser.add_argument('-dirB', default=r'G:\low-light_image_enhancement\Github\END\results\MIT_END\test', type=str)
